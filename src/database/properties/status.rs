...
mod unit_tests {
    ...
    fn deserialize_database_status_property() {
        ...
        assert_eq!(groups[0].color, crate::others::color::Color::Gray);
        assert_eq!(
            groups[0].option_ids,
        ...
        assert_eq!(groups[1].color, crate::others::color::Color::Blue);
        assert_eq!(
            groups[1].option_ids,
        ...
        assert_eq!(groups[2].color, crate::others::color::Color::Green);
        assert_eq!(
            groups[2].option_ids,
