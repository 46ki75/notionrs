...
> [!INFO]
> You can find the official documentation [here](https://developers.notion.com/reference/get-block-children).

## Basic Usage

To retrieve block children, you can use the following example:
